...
@interface HMPhotoBrowserCollectionViewCell ()<UIScrollViewDelegate>
@property (strong, nonatomic)HMPhotoModel *photoModel;
@property (strong, nonatomic)UIImageView *largeImage;
@end

@implementation HMPhotoBrowserCollectionViewCell
...
- (void)setDataWithModel:(HMPhotoModel *)model imageManager:(PHCachingImageManager *)imageManager {
  ...
  [imageManager requestImageForAsset:asset
                       ...
                       resultHandler:^(UIImage *result, NSDictionary *info) {
                         if ([_photoModel.photoAssert.localIdentifier isEqualToString:asset.localIdentifier]) {
